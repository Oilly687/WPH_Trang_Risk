...
<?php
   ...
   $q_id_form = "SELECT MAX(id2) as lastid FROM ps"; 
    ...
    $sql = sprintf(
		"
		INSERT INTO `ps`
		( `id2`, `name_ps`, `phone_ps`, `email_ps`, `dob`, `risk_ps` , `gender_ps`, `time`, `overS`, `lgg_ps` , `kam_ps`, `exr_ps`, `dm_ps`, `rk_ps`, `psh_ps`, `spsh_ps`, `age_ps`,`active`,`ip`,`ti`)
		VALUES
		   ...
		   mysqli_real_escape_string($conn,$_POST['lgg']),  
		   mysqli_real_escape_string($conn,$_POST['kam']),
		   mysqli_real_escape_string($conn,$_POST['exr']), 
		   mysqli_real_escape_string($conn,$_POST['dm']),  
		   mysqli_real_escape_string($conn,$_POST['rk']), 
		   mysqli_real_escape_string($conn,$_POST['psh']),
		   mysqli_real_escape_string($conn,$_POST['spsh']),  
		   mysqli_real_escape_string($conn,$_POST['age']),"1",
...
$sql_form_rec = "SELECT * FROM ps Where  name_ps = '$name' and dob = '$dob' and phone_ps = '$phone' ";
$query_form_rec = mysqli_query($conn,$sql_form_rec);

$result_form_rec=mysqli_fetch_array($query_form_rec);
$from_id = $result_form_rec["id2"];
