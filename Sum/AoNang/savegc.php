...
<?php
   ...
   $q_id_form = "SELECT MAX(id) as lastid FROM gc"; 
    ...
    $sql = sprintf(
		...
		"
		INSERT INTO `gc`
		( `id`, `name`, `phone`, `email`, `dob`, `risk` , `gender`, `sgc`, `dlsk`, `devf` , `epy`, `sbh`, `overS`, `sg`, `rk`, `time`, `active`, `ip`,`ti`)
		VALUES
		   ...
		   mysqli_real_escape_string($conn,$_POST['sgc']),  
		   mysqli_real_escape_string($conn,$_POST['dlsk']),  
		   mysqli_real_escape_string($conn,$_POST['devf']),   
		   mysqli_real_escape_string($conn,$_POST['epy']),
		   mysqli_real_escape_string($conn,$_POST['sbh']),  
		   mysqli_real_escape_string($conn,$_POST['overS']),   
		   mysqli_real_escape_string($conn,$_POST['sg']), 
...
$sql_form_rec = "SELECT * FROM gc Where  name = '$name' and dob = '$dob' and phone = '$phone' ";
