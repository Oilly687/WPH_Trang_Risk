...
<?php
	...
	$q_id_form = "SELECT MAX(id) as lastid FROM ost"; 
	...
	$id_form = $row_id_form['lastid'];
     ...
     $sql = sprintf(
		"
		INSERT INTO `ost`
		( `id`, `name`, `phone`, `email`, `dob`, `weight` , `risk`, `gender`, `time`, `active`, `ip`,`ti`)
		VALUES
...
<?php
   ...
   $sql_form_rec = "SELECT * FROM ost Where  name = '$name' and dob = '$dob' and phone = '$phone' ";
