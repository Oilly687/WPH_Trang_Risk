...
<?php
	...
	$q_id_form = "SELECT MAX(id) as lastid FROM stroke"; 
    ...
    $sql = sprintf(
		"
		INSERT INTO `stroke`
		( `id`, `name`, `phone`, `email`, `dob`, `risk` , `gender`, `amp`, `sk`, `ps` , `dm`, `cal`, `overS`, `sst`, `cadi`, `time`,`active`,`ip`,`ti`)
		VALUES
		   ...
		   mysqli_real_escape_string($conn,$_POST['amp']), 
		   mysqli_real_escape_string($conn,$_POST['sk']),  
		   mysqli_real_escape_string($conn,$_POST['ps']),  
		   mysqli_real_escape_string($conn,$_POST['dm']),
		   mysqli_real_escape_string($conn,$_POST['cal']),  
		   mysqli_real_escape_string($conn,$_POST['overS']),  
		   mysqli_real_escape_string($conn,$_POST['sst']), 
		   mysqli_real_escape_string($conn,$_POST['cadi']),
		   date("Y-m-d H:i:s"), 
		   "1",mysqli_real_escape_string($conn,$ip),
		   date("H:i:s")
...
$sql_form_rec = "SELECT * FROM stroke Where  name = '$name' and dob = '$dob' and phone = '$phone' ";
