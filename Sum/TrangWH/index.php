...
<head>
  ...
  <title>ระบบประเมินความเสี่ยงโรค ตรัง</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link rel="icon" href="trang.jpg">
...
<body>
  ...
  <div id="topbar" class="d-flex align-items-center fixed-top">
    <div class="container d-flex justify-content-between">
      <div class="d-none d-lg-flex social-links align-items-center">
        ...
        <a href="https://www.facebook.com/wattanapattranghospital" class="facebook"><i class="bi bi-facebook"></i></a>
        <a href="https://www.instagram.com/wattanapathospital_trang/" class="instagram"><i class="bi bi-instagram"></i></a>
      </div>
    </div>
  </div>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.php"> <img src="WHT.png" class="img-fluid" style="max-height: 50px;"/></a></h1>
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="https://wattanapat.co.th/appointment.html?docid=9"> <i class="fa-solid fa-calendar-check"></i> &nbsp; นัดพบแพทย์</a></li>
        </ul>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container">
      <h1>Welcome to <br> Wattanapat Hospital Trang</h1>
  ...
  <section id="services" class="services" style=" background: #ffff;">
    ...
    <section id="contact" class="contact">
      ...
      <div>
        <iframe style="border:0; width: 100%; height: 350px;"<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3955.102725590723!2d99.61523661525217!3d7.563778112292585!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x304d8c386a1c17e7%3A0xc5a60bf94d263d8e!2z4LmC4Lij4LiH4Lie4Lii4Liy4Lia4Liy4Lil4Lin4Lix4LiS4LiZ4LmB4Lie4LiX4Lii4LmMIOC4leC4o-C4seC4hyBXYXR0YW5hcGF0IEhvc3BpdGFsIFRyYW5n!5e0!3m2!1sth!2sth!4v1657526725069!5m2!1sth!2sth" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>       </div>
          ...
          <div class="col-lg-4">
            <div class="info">
              <div class="address">
                ...
                <h4>Location:</h4>
                <p>โรงพยาบาลวัฒนแพทย์ ตรัง 247/2 ถ.พัทลุง ต.ทับเที่ยง อ.เมือง จ.ตรัง 92000</p>
              </div>
              <div class="phone">
                <i class="bi bi-phone"></i>
                <h4>Call:</h4>
                 <p>โทร. 0-7520-5555 <br>
                    ฉุกเฉินโทร. 0-7520-5500 <br>
                    096-635-3046</p> 
              </div>
              <div class="email">
                <i class="bi bi-envelope"></i>
                <h4>Email:</h4>
                <p>contact@wattanapat.co.th</p>
              </div>
  ...
  <footer id="footer">
    <div class="container d-md-flex py-4">
      ...
      <div class="me-md-auto text-center text-md-start">
        <div class="copyright">
         <strong><span>โรงพยาบาลวัฒนแพทย์</span></strong>&nbsp;ตรัง
        </div>
        <div class="credits">
         ที่อยู่ :โรงพยาบาลวัฒนแพทย์  ตรัง 247/2 ถ.พัทลุง ต.ทับเที่ยง อ.เมือง จ.ตรัง 92000</a>
      ...
      <div class="social-links text-center text-md-right pt-3 pt-md-0">
        ...
        <a href="https://www.facebook.com/wattanapattranghospital" class="facebook"><i class="bx bxl-facebook"></i></a>
        <a href="https://www.instagram.com/wattanapathospital_trang/" class="instagram"><i class="bx bxl-instagram"></i></a>
