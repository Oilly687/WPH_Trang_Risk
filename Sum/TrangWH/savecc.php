...
<?php
   ...
   $q_id_form = "SELECT MAX(id) as lastid FROM cc"; 
    ...
    $sql = sprintf(
	 "
	 INSERT INTO `cc`
	 ( `id`, `name`, `phone`, `email`, `dob`, `risk` , `sex`, `age50`, `aub`, `pau` , `aup`, `rj`, `kg`, `ta`, `cks`, `stc` , `dm`, `overS`, `lih`, `epy` , `dlg`, `time`, `scc`,`active`,`ip`,`ti` )
	 VALUES
    	...
    	mysqli_real_escape_string($conn,$_POST['age50']),
    	mysqli_real_escape_string($conn,$_POST['aub']),  
    	mysqli_real_escape_string($conn,$_POST['pau']),  
    	mysqli_real_escape_string($conn,$_POST['aup']),   
    	mysqli_real_escape_string($conn,$_POST['rj']),
    	mysqli_real_escape_string($conn,$_POST['kg']),  
    	mysqli_real_escape_string($conn,$_POST['ta']),   
    	mysqli_real_escape_string($conn,$_POST['cks']),
    	mysqli_real_escape_string($conn,$_POST['stc']),
    	mysqli_real_escape_string($conn,$_POST['dm']),  
    	mysqli_real_escape_string($conn,$_POST['overS']),   
    	mysqli_real_escape_string($conn,$_POST['lih']),   
    	mysqli_real_escape_string($conn,$_POST['epy']),
    	mysqli_real_escape_string($conn,$_POST['dlg']),   
    	date("Y-m-d H:i:s"), 
    	mysqli_real_escape_string($conn,$_POST['scc']),"1",
...
$sql_form_rec = "SELECT * FROM cc Where  name = '$name' and dob = '$dob' and phone = '$phone' ";
