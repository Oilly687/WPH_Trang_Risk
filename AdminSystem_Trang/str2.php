				...
				<div class="row align-items-center">
					<div class="col-md-6">
						...
						<ul class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="#!">โรคหลอดเลือดสมอง</a></li>
...
<div class="col-md-6">
		...
		<div class="row">
			...
			<div class="col-sm-12">
				<div class="card">
					<div class="card-header">ข้อมูลทั้งหมดของการประเมินความเสี่ยงโรคหลอดเลือดสมอง</div>
					<div class="card-body">
             ...
             <thead>
                <tr>
                   ...
                   <th>DOB</th>
                   <th>ความเสี่ยง</th>
                   <th>ญาติเป็นอัมพฤกษ์</th>
                   <th>สูบบุหรี่</th>
                   <th>ความดันโลหิต</th>
                   <th>เบาหวาน</th>
                   <th>ไขมัน</th>
                   <th>โรคอ้วน</th>
                   <th>ประวัติโรคหลอดเลือดสมอง</th>
                   <th>ประวัติโรคหัวใจ</th>
                   <th>มือถือ</th>
                   <th>อีเมล</th>
                   <th>วันที่</th>
                   <th>เวลา</th>
                ...
                <?php
                $emp_query = "SELECT name, gender, dob, risk, amp, sk, ps, dm, cal, overS, sst, cadi, phone, email, time, ti, (YEAR(NOW()) - YEAR(`dob`)) as old FROM `stroke` WHERE active = '1'";
...
<?php
$query = "SELECT gender, COUNT(gender) as total FROM stroke WHERE active='1'";
if(isset($_POST['but_search'])){
    $fromDate = $_POST['fromDate'];
    $endDate = $_POST['endDate'];
...
?>
	...
	<?php
$query1 = "SELECT risk, COUNT(risk) as total FROM stroke WHERE active='1'";
if(isset($_POST['but_search'])){
    $fromDate = $_POST['fromDate'];
    $endDate = $_POST['endDate'];
