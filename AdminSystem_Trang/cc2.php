				...
				<div class="row align-items-center">
					<div class="col-md-6">
						...
						<ul class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="#!">โรคมะเร็งลำไส้</a></li>
...
<div class="col-md-6">
		...
		<div class="row">
			...
			<div class="col-sm-12">
				<div class="card">
					<div class="card-header">ข้อมูลทั้งหมดของการประเมินความเสี่ยงโรคมะเร็งลำไส้</div>
					<div class="card-body">
               ...
               <thead>
                <tr>
                   ...
                   <th>อีเมล</th>
                   <th>ความเสี่ยง</th>
                   <th>อายุมากกว่า 50</th>
                   <th>อุจจาระเป็นมูกเลือด</th>
                   <th>ปวดเบ่ง</th>
                   <th>ท้องผูก</th>
                   <th>อาจมีคลื่นไส้</th>
                   <th>อาจคลำก้อน</th>
                   <th>มีประวัติญาติ</th>
                   <th>มีประวัติพบเนื้องอก</th>
                   <th>ลำไส้อักเสบ</th>
                   <th>ประวัติเจ็บป่วย</th>
                   <th>เป็นโรคเบาหวาน</th>
                   <th>เป็นโรคอ้วน</th>
                   <th>ทานอาหารไขมันสูง</th>
                   <th>ทานอาหารปิ้งย่าง</th>
                   <th>ดื่มสุราหรือสูบบุหรี่</th>
                   <th>วันที่</th>
                   <th>เวลา</th>
                   <th>อายุ</th>
                </tr>
                ...
                <?php
                $emp_query = "SELECT name, sex, dob, phone, email, risk,  age50, aub,  pau, aup, rj, kg, ta, scc, cks, stc, dm, overS, lih, epy, dlg, time, ti, (YEAR(NOW()) - YEAR(`dob`)) as old FROM `cc` WHERE active = '1'";
...
<?php
$query = "SELECT sex, COUNT(sex) as total FROM cc WHERE active='1'";
if(isset($_POST['but_search'])){
    $fromDate = $_POST['fromDate'];
    $endDate = $_POST['endDate'];
...
?>
	...
	<?php
$query1 = "SELECT risk, COUNT(risk) as total FROM cc WHERE active='1'";
if(isset($_POST['but_search'])){
    $fromDate = $_POST['fromDate'];
    $endDate = $_POST['endDate'];
