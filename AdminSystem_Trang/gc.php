				...
				<div class="row align-items-center">
					<div class="col-md-6">
						...
						<ul class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="#!">โรคมะเร็งกระเพาะ</a></li>
...
<div class="col-md-6">
		...
		<div class="row">
			...
			<div class="col-sm-12">
				<div class="card">
					<div class="card-header">ข้อมูลทั้งหมดของการประเมินความเสี่ยงโรคมะเร็งกระเพาะ</div>
					<div class="card-body">
              ...
              <thead>
                <tr>
                     ...
                     <th>มีประวัติครอบครัวเป็นโรคมะเร็งกระเพาะอาหาร</th>
                     <th>สูบบุหรี่ ดื่มแอลกอฮอล์</th>
                     <th>ไม่ค่อยรับประทานผักและผลไม้</th>
                     <th>กินอาหารปิ้งย่างหมักดอง</th>
                     <th>เชื้อแบคทีเรียเฮอริโคแบคเตอร์</th>
                     <th>เป็นโรคอ้วน</th>
                     <th>ผ่าตัดกระเพาะอาหาร</th>
                     <th>เคยมีอาการท้องอืด</th>
                     <th>เบอร์โทรศัพท์</th>
                     <th>อีเมล</th>
                     <th>วันที่</th>
                     <th>เวลา</th>
                ...
                <?php
                $emp_query = "SELECT name, gender, dob, risk, sgc, dlsk, devf, epy, sbh, overS, sg, rk, phone, email, time, ti, (YEAR(NOW()) - YEAR(`dob`)) as old  FROM `gc` WHERE active = '1'";
...
<?php
$query = "SELECT gender, COUNT(gender) as total FROM gc WHERE active='1'";
if(isset($_POST['but_search'])){
    $fromDate = $_POST['fromDate'];
    $endDate = $_POST['endDate'];
...
?>
	...
	<?php
$query1 = "SELECT risk, COUNT(risk) as total FROM gc WHERE active='1' ";
if(isset($_POST['but_search'])){
    $fromDate = $_POST['fromDate'];
    $endDate = $_POST['endDate'];
