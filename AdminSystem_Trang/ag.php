				...
				<div class="row align-items-center">
					<div class="col-md-6">
						...
						<ul class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="#!">โรคภูมิแพ้</a></li>
...
<div class="col-md-6">
		...
		<div class="row">
			...
			<div class="col-sm-12">
				<div class="card">
					<div class="card-header">ข้อมูลทั้งหมดของการประเมินความเสี่ยงโรคภูมิแพ้</div>
					<div class="card-body">
               ...
               <thead>
                <tr>
                     ...
                     <th>คันและเคืองตา</th>
                     <th>อาการจาม คันจมูก น้ำมูกไหล</th>
                     <th>ไอ หอบเหนื่อย หายใจขัด</th>
                     <th>คัน มีผดผื่นตามตัว ผื่นมักแห้ง</th>
                     <th>มีอาหารหลังทาน นม ไข่ และอื่นๆ</th>
                     <th>เบอร์โทรศัพท์</th>
                     <th>อีเมล</th>
                     <th>วันที่</th>
                     <th>เวลา</th>
                ...
                <?php
                $emp_query = "SELECT name, gender, dob, risk, rke, rkn, rkl, rks, rkf, phone, email, time, ti,(YEAR(NOW()) - YEAR(`dob`)) as old  FROM `ag` WHERE active = '1'";
...
<?php
$query = "SELECT gender, COUNT(gender) as total FROM ag WHERE active='1'";
if(isset($_POST['but_search'])){
    $fromDate = $_POST['fromDate'];
    $endDate = $_POST['endDate'];
...
?>
	...
	<?php
  $query1 = "SELECT risk, COUNT(risk) as total FROM ag WHERE active='1'";
  if(isset($_POST['but_search'])){
    $fromDate = $_POST['fromDate'];
    $endDate = $_POST['endDate'];
