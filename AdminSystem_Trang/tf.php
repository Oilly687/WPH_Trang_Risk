				...
				<div class="row align-items-center">
					<div class="col-md-6">
						...
						<ul class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="#!">โรคนิ้วล็อค</a></li>
...
<div class="col-md-6">
		...
		<div class="row">
			...
			<div class="col-sm-12">
				<div class="card">
					<div class="card-header">ข้อมูลทั้งหมดของการประเมินความเสี่ยงโรคนิ้วล็อค</div>
					<div class="card-body">
                ...
                <thead>
                  <tr>
                     ...
                     <th>มีโรคประจำตัว รูมาตอยด์ เบาหวาน เก๊าท์</th>
                     <th>มีอาการปวดบริวเณโคนนิ้ว</th>
                     <th>อาการสะดุดเวลาขยับนิ้ว</th>
                     <th>เมื่องอนิ้วจะมีอาการติดล็อค</th>
                     <th>มีอาการอักเสบและบวม</th>
                     <th>เบอร์โทรศัพท์</th>
                     <th>อีเมล</th>
                     <th>วันที่</th>
                     <th>เวลา</th>
                ...
                <?php
                $emp_query = "SELECT name, gender, dob, dof, pk, pkf, risk, fh, ks, phone, email, time, ti, (YEAR(NOW()) - YEAR(`dob`)) as old  FROM `tf` WHERE active = '1'";
...
<?php
$query = "SELECT gender, COUNT(gender) as total FROM tf WHERE active='1'";
if(isset($_POST['but_search'])){
    $fromDate = $_POST['fromDate'];
    $endDate = $_POST['endDate'];
...
?>
	...
	<?php
$query1 = "SELECT risk, COUNT(risk) as total FROM tf WHERE active='1'";
if(isset($_POST['but_search'])){
    $fromDate = $_POST['fromDate'];
    $endDate = $_POST['endDate'];
